let fs,path,BaseController,logger;_661‍.x([["Paths",()=>Paths],["RegisterControllers",()=>RegisterControllers],["RegisterSocketHandlers",()=>RegisterSocketHandlers],["attachHandlers",()=>attachHandlers]]);_661‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_661‍.w("path",[["default",["path"],function(v){path=v}]]);_661‍.w("./server/utils/BaseController",[["default",["BaseController"],function(v){BaseController=v}]]);_661‍.w("./server/utils/Logger",[["logger",["logger"],function(v){logger=v}]]);
  ...
  async function loadController(controllerName) {
    try {
      ...
      const fileHandler = await _661‍.i(Paths.Controllers + '/' + controllerName)
...
const HANDLERS = []
  ...
  handlers.forEach(async(handlerName) => {
    try {
      ...
      const fileHandler = await _661‍.i(directory + '/' + handlerName)
